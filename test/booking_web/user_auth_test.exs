defmodule BookingWeb.UserAuthTest do
  use BookingWeb.ConnCase

  alias Booking.Accounts
  alias Booking.Accounts.Scope
  alias BookingWeb.UserAuth

  import Booking.AccountsFixtures

  @remember_me_cookie "_booking_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BookingWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
