...
places = [
  ...
  %{
    ...
    location: "Aspen, CO",
    price_per_night: Decimal.new("300.00"),
  ...
  %{
    ...
    price_per_night: Decimal.new("200.00"),
  ...
  %{
    ...
    price_per_night: Decimal.new("400.00"),
  ...
  %{
    ...
    location: "Phoenix, AZ",
    price_per_night: Decimal.new("350.00"),
  ...
  %{
    ...
    price_per_night: Decimal.new("275.00"),
  ...
  %{
    ...
    location: "Costa Rica",
    price_per_night: Decimal.new("320.00"),
  ...
  %{
    ...
    price_per_night: Decimal.new("500.00"),
  ...
  %{
    ...
    price_per_night: Decimal.new("450.00"),
...
bookings = [
  %{
    ...
    state: "confirmed",
    total_price: Decimal.new("1750.00"),
    place_id: 1,
    user_id: 1
  },
  %{
    ...
    state: "pending",
    total_price: Decimal.new("1500.00"),
    place_id: 2,
    user_id: 2
  },
  %{
    ...
    state: "cancelled",
    total_price: Decimal.new("2100.00"),
    place_id: 3,
    user_id: 3
  }
]
